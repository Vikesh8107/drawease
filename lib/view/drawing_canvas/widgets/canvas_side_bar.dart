...
import 'package:drawease/main.dart';
import 'package:drawease/view/drawing_canvas/models/drawing_mode.dart';
import 'package:drawease/view/drawing_canvas/models/sketch.dart';
import 'package:drawease/view/drawing_canvas/widgets/color_palette.dart';
...
class CanvasSideBar extends HookWidget {
          ...
          children: [
            ...
            Center(
              child: GestureDetector(
                onTap: () => _launchUrl('https://github.com/Vikesh8107'),
                child: const Text(
                  'Made with 💙 by Vikeshhhh',
                  style: TextStyle(fontSize: 12),
                ),
              ),
            ),
  ...
  void saveFile(Uint8List bytes, String extension) async {
    ...
    // the else part have been removed for resolving the error
  }
